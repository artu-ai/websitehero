...
import { ArrowDownFromLine, User2 } from "lucide-react";
import { CamaraDiputadosLogo } from './Icons/CamaraDiputadosLogo';
import { ArtuLogo } from "./Icons";
import { DOFLogo } from './Icons/DOFLogo';
import { ConamerLogoNew } from './Icons/ConamerLogoNew'; 
import { CNBVLogo } from './Icons/CNBVLogo';
import { BancoDeMexicoLogo } from './Icons/BancoDeMexicoLogo';
...
const Icons = {
  notion: () => (
    <svg className={className} xmlns="http://www.w3.org/2000/svg" viewBox="0 0 200 200">
      <image 
        href="https://res.cloudinary.com/dfmpmintr/image/upload/v1726267343/Logo_artu_pequeno_1_kaawmx.png" 
        width="100%" 
        height="100%" 
  ...
  openai: () => (
    ...
    <image href="https://res.cloudinary.com/dfmpmintr/image/upload/v1726267343/Logo_artu_pequeno_1_kaawmx.png" width="200" height="200" />  
    </svg>
  ),
  googleDrive: () => (
    <svg
